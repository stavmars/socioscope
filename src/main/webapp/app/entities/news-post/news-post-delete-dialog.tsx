  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="socioscopeApp.newsPost.delete.question">
          <Translate contentKey="socioscopeApp.newsPost.delete.question" interpolate={{ id: newsPostEntity.id }}>
            Are you sure you want to delete this NewsPost?
          </Translate>
        </ModalBody>
        <ModalFooter>
