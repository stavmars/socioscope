...
import { getSearchEntities, getEntities } from './measure.reducer';
    ...
    return (
      <div>
        <h2 id="measure-heading">
          <Translate contentKey="socioscopeApp.measure.home.title">Measures</Translate>
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('socioscopeApp.measure.home.search')}
                  />
