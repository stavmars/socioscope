...
import { getSearchEntities, getEntities } from './code.reducer';
...
export class Code extends React.Component<ICodeProps, ICodeState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="code-heading">
          <Translate contentKey="socioscopeApp.code.home.title">Codes</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="socioscopeApp.code.home.createLabel">Create new Code</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('socioscopeApp.code.home.search')}
                  />
