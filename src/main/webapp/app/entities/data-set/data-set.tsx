...
import { getSearchEntities, getEntities } from './data-set.reducer';
...
export class DataSet extends React.Component<IDataSetProps, IDataSetState> {
  state: IDataSetState = {
    search: ''
  };
    ...
    return (
      <div>
        <h2 id="data-set-heading">
          <Translate contentKey="socioscopeApp.dataSet.home.title">Data Sets</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="socioscopeApp.dataSet.home.createLabel">Create new Data Set</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('socioscopeApp.dataSet.home.search')}
                  />
