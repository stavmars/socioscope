  ...
  <div>
    ...
    <Container text className="blog-page-description">
      ...
      <p>
        ...
        είχαν την ευκαιρία να περιηγηθούν στα δεδομένα του <b>Socioscope.gr</b>, να δουν τις λειτουργίες της πλατφόρμας, να την
      ...
      <p>
        ...
        , καθ. Νίκος Δεμερτζής, κατά την εναρκτήρια ομιλία του αναφέρθηκε στον καινοτόμο χαρακτήρα του έργου, με έμφαση στη σημασία των
        τεκμηριωμένων δεδομένων και την αξία της διεπιστημονικότητας κατά τη μελέτη κοινωνικών αλληλεπιδράσεων.
      </p>
      <p>
        Και από τη θεωρία... περάσαμε στην πράξη! Οι Ερευνήτριες του Ινστιτούτου Κοινωνικών Ερευνών του{' '}
        <a href="https://www.ekke.gr" target="_blank">
          ΕΚΚΕ
        </a>{' '}
        και επιστημονικές υπεύθυνες των θεματικών που παρουσιάστηκαν, Δρ. Μανίνα Κακεπάκη και Δρ. Κατερίνα Ηλιού μας “σύστησαν” αρχικά{' '}
        <a href="https://socioscope.gr/dataset/deputies/data?type=chart&subType=column&x=elections.assembly&measure=deputies">
          τη μοναδική απογραφική βάση όλων των βουλευτών/-τριών
        </a>{' '}
        που εκλέχθηκαν στο Ελληνικό Κοινοβούλιο (1989-2019) και φιλοξενείται στο <b>Socioscope.gr</b>. Στη συνέχεια παρουσίασαν αποτελέσματα
        από τη θεματική του <b>Socioscope.gr</b> για{' '}
        <a href="https://socioscope.gr/dataset/adolescents/data?type=chart&subType=column&x=q2&measure=adolescents_perc">
          το προφίλ και τις αξίες των εφήβων
        </a>{' '}
        με δεδομένα έρευνας πεδίου που πραγματοποιήθηκε το 2018 σε 4 σχολικές μονάδες της Αττικής.
      </p>
      <p>
      ...
      <p>
        ...
        ετοιμάζει η ίδια ομάδα του{' '}
        <a href="https://www.ekke.gr" target="_blank">
          ΕΚΚΕ
        </a>{' '}
        και αφορά στους νέους/-ες από 17-29 ετών στην Ελλάδα. Πραγματοποιήθηκε μάλιστα, η πρώτη επίσημη προβολή του promotion video που
        ετοιμάστηκε για τους σκοπούς αυτούς.
      </p>
      <p>
      ...
      <p>
        ...
        , καθ. Νίκος Δεμερτζής αναφέρθηκε μεταξύ άλλων στη σημασία των τεκμηριωμένων δεδομένων σήμερα και την αξία της διεπιστημονικότητας
        κατά τη μελέτη κοινωνικών αλληλεπιδράσεων.
      </p>
